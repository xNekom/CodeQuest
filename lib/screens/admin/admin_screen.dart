  ...
  void initState() {
    ...
    _adminGridItems = [
      _AdminGridItem(
        title: 'Usuarios',
        icon: Icons.person,
        contentBuilder: () => _buildUsersTab(),
      ),
      _AdminGridItem(
        title: 'Misiones',
        icon: Icons.flag,
        contentBuilder: () => _buildMissionsTab(),
      ),
      _AdminGridItem(
        title: 'Items',
        icon: Icons.inventory,
        contentBuilder: () => _buildItemsTab(),
      ),
      _AdminGridItem(
        title: 'Enemigos',
        icon: Icons.shield,
        contentBuilder: () => _buildEnemiesTab(),
      ),
      _AdminGridItem(
        title: 'Clasificación',
      ...
      _AdminGridItem(
        ...
        contentBuilder: () => _buildQuestionsTab(),
      ),
      _AdminGridItem(
        title: 'Recompensas',
        icon: Icons.star,
        contentBuilder: () => _buildRewardsTab(),
      ),
      _AdminGridItem(
        title: 'Logros',
        icon: Icons.emoji_events,
        contentBuilder: () => _buildAchievementsTab(),
      ),
      _AdminGridItem(
        title: 'Logs de Errores',
        icon: Icons.error_outline,
        contentBuilder: () => _buildErrorLogsTab(),
      ),
    ];
  ...
  Widget _buildLeaderboardsTab() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final docs = snapshot.data!.docs;
        if (docs.isEmpty)
          return const Center(child: Text('No hay entradas de clasificación.'));
        return ListView.separated(
          itemCount: docs.length,
          separatorBuilder: (_, __) => const Divider(),
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              trailing: Row(
                ...
                children: [
                    ...
                    onPressed: () {
                      ...
                      showDialog(
                        ...
                        builder:
                            (_) => AlertDialog(
                              title: const Text(
                                'Editar Entrada de Clasificación',
                              ),
                              content: Form(
                                key: formKey,
                                child: SingleChildScrollView(
                  ...
                  IconButton(
                    icon: const Icon(Icons.delete),
                    onPressed: () => _leaderboardsCol.doc(doc.id).delete(),
                  ),
                ],
              ),
            );
